...
class ToolBarCreator:
    ...
    def create_tool_bar(self):
        ...
        add_node_button.setIconSize(QSize(32, 32))
        ...
        remove_edge_button.setIconSize(QSize(32, 32))
        ...
        reset_color_button.setIconSize(QSize(32, 32))
